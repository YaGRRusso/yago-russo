...
function currentAge(birth) {
  ...
  return Math.floor(
    Math.ceil(
      Math.abs(birthday.getTime() - date.getTime()) / (1000 * 3600 * 24)
    ) / 365.25
  );
}
...
let experiencies = [
  {
    ...
    description:
      "Aulas de Programação, Design e Tecnologias | Suporte de Rede e Máquinas | Design de Artes",
  },
  {
    name: "Jovem Aprendiz",
...
let formations = [
  {
    ...
    description:
      "Libre Office | C++ | Java | Html5 | CSS3 | PHP | MySQL | JavaScript | Bootstrap| Kodular | Firebase | Cisco Packet | Manutenção e Formatação | Linux",
  },
];
...
let courses = [
  ...
  },
  {
    ...
    hours: 90,
    description:
      "Word | Excel | Power Point | Windows | Montagem, Manutenção e Formatação",
    link: "",
  },
  {
    name: "Logística",
...
let portfolio = [
  {
    ...
    img: "cactus",
    stacks: ["html5", "bootstrap", "jquery", "php", "mysql"],
  },
  {
    name: "Original Redes",
  ...
  },
  {
    ...
    img: "gallery",
    stacks: ["react", "typescript", "firebase", "styled-components"],
  },
  {
    name: "Cadastro DEV",
    ...
    img: "cadastro",
    stacks: ["react", "typescript", "styled-components", "router-dom"],
  },
  {
    name: "AWAX",
